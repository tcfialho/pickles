...
namespace PicklesDoc.Pickles.DocumentationBuilders.Dhtml.UnitTests
{
    ...
    public class WhenDoingSomeIntegrationTests : BaseFixture
    {
        ...
        public void TestTheResourceWriter()
        {
            ...
            {
                OutputFolder = FileSystem.DirectoryInfo.FromDirectoryName(@"d:\output")
            };
        ...
        {
            var filePath = @"d:\output\pickledFeatures.json";
        ...
        {
            var oldfilePath = @"d:\output\pickledFeatures.json";
            var newFilePath = @"d:\output\pickledFeatures.js";
