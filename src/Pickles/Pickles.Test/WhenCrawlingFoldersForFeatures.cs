...
namespace PicklesDoc.Pickles.Test
{
    ...
    public class WhenCrawlingFoldersForFeatures : BaseFixture
    {
        ...
        public void Then_can_crawl_all_folders_including_subfolders_for_features_successfully()
        {
            ...
            var image = features.ChildNodes[2].Data;
            ...
            var levelOneRemoveTagsToHide = features.ChildNodes[3].Data;
            ...
            var subLevelOneDirectory = features.ChildNodes[4].Data;
            ...
            var subLevelOneNode = features.ChildNodes[4];
